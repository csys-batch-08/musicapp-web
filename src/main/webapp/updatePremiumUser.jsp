			...
			<table id="signuptable" style="border-spacing: 5px;">
				...
				<tr>
					...
					<th id="lname"><input type="text" name="LastName" id="name"
						value="${premiumUser.lastName}" placeholder="Enter your last name"
				...
				<tr>
					...
					<th id="mailid"><input type="email" name="UserEmail"
						id="emailId" value="${premiumUser.emailId}"
				...
				<tr>
					...
					<th id="uname"><input type="text" name="UserName" id="name"
						value="${premiumUser.userName}" placeholder="Enter user name"
						pattern="[a-z]{2,20}" required></th>
				</tr>
				<tr>
					<th id="password"><label for="password">Password:</label></th>
					<th id="password"><input type="password" name="UserPassword"
						id="password" value="${premiumUser.password}"
						placeholder="********" pattern="[a-zA-Z0-9@#]{5,10}" required></th>
				</tr>
				<tr>
					<th id="mobnum"><label for="mobile">Mobile Number:</label></th>
					<th id="mobnum"><input type="number" name="MobileNumber"
						id="mobile" value="${premiumUser.mobileNumber}"
						placeholder="Enter mobile number" pattern="[0-9]{10}" required></th>
				</tr>
				<tr>
					<th id="wallet"><label for="wallet">Wallet (Rs):</label></th>
					<th id="wallet"><input type="number" name="wallet"
						id="wallet" value="${premiumUser.wallet}" readonly="readonly"></th>
				</tr>
				<tr>
